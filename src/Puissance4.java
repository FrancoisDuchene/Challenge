...
public class Puissance4
{
	...
	private static byte nombreJoueurs = 1;
	private static byte difficulte = 3;
	...
	public static void jouer()
	{
			...
			while(!fin())
			{
				...
				else
				{
					...
					if(allignement4())
					{
						...
						{
							System.out.println("The player " + num + "won the game !");
		...
		if(fin())
		{
			...
			if(!profilGestion.getPremierOuverture())
			{profilGestion.ajouteScoreSPU(42);
			profilGestion.saveProfil();}
		}
	}
	...
	public static int calculScore(boolean gagne)
	{
		int score = 0;
		if(gagne)
		{
	...
	public static byte getNbrJoueurs()
	{
		return nombreJoueurs;
	}
	public static byte getDifficulte()
	{
		return difficulte;
	}
	/**
	 * 
	 * @param nbrJoueurs a byte 
	 * @param difficultie a byte
	 */
	public static void setParam(byte nbrJoueurs, byte difficultie)
	{
		nombreJoueurs = nbrJoueurs;
		difficulte = difficultie;
	}
}