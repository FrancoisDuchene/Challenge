		...
		prop2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event)
			{
				if(langue==1)
				{
					...
					String choix = (String) JOptionPane.showInputDialog(null,"Sur quel jeu voulez-vous des infos?","Jeux",JOptionPane.QUESTION_MESSAGE, null,jeux,jeux[3]);
					String corps = "";
					...
					String[] jeux = {"Hangman","HighLow","Mastermind","Connect 4"};
					String choix = (String) JOptionPane.showInputDialog(null,"On which game do you want in","Jeux",JOptionPane.QUESTION_MESSAGE, null,jeux,jeux[3]);
					String corps = "";

					if(choix.equals("Hangman"))
					{corps = "First game developped in challenge.\nThe goal is to find a word in trying to put characters.\nIf you try to many bad characters, you lose.";}
					else if(choix.equals("HighLow"))
					{corps = "Second game developped in challenge.\nThe goal is to find a random number between two bornes.\nEastersEggs are hidden ;)";}
					else if(choix.equals("Mastermind"))
					{corps = "Third game developped in challenge.\nYou must find the right combinaison of random colors picked by the computer.";}
					else if(choix.equals("Connect 4"))
					{corps = "Four game developped in challenge.\nYou must align 4 jetons of your color on the grid without that the other player could align them before you";}
					JOptionPane.showMessageDialog(null,corps, choix,JOptionPane.INFORMATION_MESSAGE);
				}
			}});
